...
- All 17 volatility-parity/rebalancing direction revisions are incorporated at `b20690b0...`, but the contract is not frozen; data and implementation access remain blocked until the revised draft is committed cleanly and an immutable wrapper binds it. This is an experiment guard, not a program blocker.
