...
- `btc-eth-volatility-managed-equal-weight-v1` is active with frozen effective contract `d4765946...`, pushed pure core, and a production evaluator that passes all pre-data gates but is not yet commit-bound for its sole run. It has made no performance claim. This is normal research state, not a blocker.
