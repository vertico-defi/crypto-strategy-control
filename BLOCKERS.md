...
- `btc-eth-intraday-calendar-seasonality-v1` is frozen by wrapper `1e67b67c...`; data remains blocked until the wrapper is validated/committed and pure Terra implementation passes synthetic review, but this is not a program blocker.
