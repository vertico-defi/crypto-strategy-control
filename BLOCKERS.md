...
- `btc-eth-volatility-managed-equal-weight-v1` is active with complete revised no-data contract `d4765946...`; it is not yet frozen or implemented and has made no performance claim. This is normal research state, not a blocker.
