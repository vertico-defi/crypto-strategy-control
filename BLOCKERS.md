...
- The volatility-parity/rebalancing no-data draft exists at `0caf8e69...` but is not frozen; data and implementation access remain blocked pending a clean commit, live Sol/xhigh direction review, and mechanical incorporation of every required revision. This is an experiment guard, not a program blocker.
