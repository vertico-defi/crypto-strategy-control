...
- The volatility-parity/rebalancing direction review is terminal `REVISION_REQUIRED`; data and implementation access remain blocked until all 17 no-data revisions from `6978aec1...` are incorporated, hash-committed, and frozen. This is an experiment guard, not a program blocker.
