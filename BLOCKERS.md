...
- `btc-eth-volatility-managed-equal-weight-v1` exhausted its sole development invocation with `DEVELOPMENT_PIPELINE_FAILURE` before any market row or return was materialized. It has no economic result, cannot be repaired or rerun, and now awaits terminal Sol/xhigh audit. This is an experiment-level terminal state, not an overall-program blocker.
